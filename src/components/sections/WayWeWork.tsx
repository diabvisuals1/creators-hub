    ...
    () => [
      {
        ...
        desc: "We turn raw footage into polished videos built for attention, pacing, and clear storytelling.",
        bullets: [
          "Long-form YouTube editing",
          "Creator, lifestyle, and gaming videos",
          "Captions, pacing, and sound design",
          "Final export for each platform",
        ],
        icon: "/howwehelp/content-creation.svg",
        iconAlt: "Video Production icon",
      },
      {
        id: "t2",
        number: "02",
        ...
        desc: "We create clean, eye-catching visuals that help your content and brand look sharper.",
        bullets: [
          "YouTube thumbnails",
      ...
      },
      {
        ...
        desc: "For clients who need full support, we can manage their social media presence from content planning to performance analysis.",
        bullets: [
          "Content planning and scheduling",
          "Posting and platform management",
      ...
      },
      {
        ...
        desc: "We help brands shape a clear visual identity that feels professional, consistent, and ready to use across platforms.",
        bullets: [
        ...
        iconAlt: "Branding & Identity icon",
      },
      {
        id: "t5",
        number: "05",
        label: "Event Content",
        title: "Event Content",
        desc: "We support events with video edits, screen visuals, social media content, and recap assets.",
        bullets: [
          "Event promo edits",
          "Screen visuals",
          "Recap videos",
          "Sponsor and partner visuals",
        ],
        icon: "/howwehelp/analytics-reporting.svg",
        iconAlt: "Event Content icon",
      },
    ],
    []
  );
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:py-14 md:py-16">
        <div className="grid gap-6 md:grid-cols-[1fr_1fr] md:items-start">
          ...
          <p className="text-sm md:text-base leading-relaxed" style={{ color: NEON_48 }}>
            We help creators, brands, agencies, and events build a stronger presence through video production,
            design, social media management, branding, and event content.
          </p>
        </div>
